...
// We might be going through edit_slot more than once, for example if we have to log on on the way.  We
...
// This page will either add or modify a slot
