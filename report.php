<?php
// $Id: report.php 1231 2009-10-27 16:52:17Z cimorrison $
...
function escape($string)
{
  ...
  {
    $string = cdma_nl2br(htmlspecialchars($string));
  }
  return $string;
}
...
function csv_report_header($display)
{
  ...
  $nbsp = cdma_entity_decode('&nbsp;', ENT_NOQUOTES, $charset);
  for ($i=0; $i < $n_values; $i++)
  {
    $values[$i] = cdma_entity_decode($values[$i], ENT_NOQUOTES, $charset);
